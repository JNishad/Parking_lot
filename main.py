...
def command_handler(command):
    ...
    # display current parking lot rates
        ...
        input("Current Parking Rates:\n"
              "Cars - Rs.30.00/hour\n"
              "Trucks - Rs. 45.00/hour\n"
              "Motorcycles - Rs.20.00/hour\n"
              "\nPress Enter to return to menu")
...
def demo_mode():
    ...
    v1 = enter_vehicle(1, "12-8956", 0, 3)
    v2 = enter_vehicle(3, "14-5861", 1, 0)
    v3 = enter_vehicle(2, "12-5762", 3, 2)
    v4 = enter_vehicle(1, "12-7631", 2, 1)
    v5 = enter_vehicle(2, "14-6932", 3, 4)


    # custom epoch times
    v1.set_entry_time(1656590400)
    v2.set_entry_time(1658715400)
    v3.set_entry_time(1652113800)
    v4.set_entry_time(1656604800)
    v5.set_entry_time(1656615600)
